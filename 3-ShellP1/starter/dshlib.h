...
/**
 * Finds string "searchTerm" in string cmd_line
 * @param cmd_line  string to search
 * @param searchTerm search target
 * @return location in cmd_line of first character in search target
 */
int searchString(char *cmd_line, char *searchTerm);
/**
 *  Removes any preceding or trailing zeros from string
 * @param string string to be formated
 */
void formatString(char *string);

/**
 * prints Drexel dragon logo
 */
